...
INSERT INTO payment_gateways (id, name, code, is_active, supported_countries, supported_currencies, fee_percent, fee_fixed, config, test_mode, created_at, updated_at, priority, description) VALUES
