...
DELETE FROM customs_categories;
...
-- Add test shipping routes for the new shipping routes system
INSERT INTO shipping_routes (origin_country, destination_country, base_shipping_cost, cost_per_kg, cost_percentage, is_active, created_at, updated_at) VALUES
('US', 'IN', 25.00, 5.00, 2.5, true, NOW(), NOW()),
('US', 'UK', 15.00, 3.50, 1.8, true, NOW(), NOW()),
('US', 'CA', 12.00, 2.00, 1.2, true, NOW(), NOW()),
('US', 'AU', 35.00, 8.00, 3.0, true, NOW(), NOW()),
('US', 'DE', 18.00, 4.00, 2.0, true, NOW(), NOW()),
('US', 'FR', 20.00, 4.50, 2.2, true, NOW(), NOW()),
('US', 'JP', 30.00, 6.00, 2.8, true, NOW(), NOW()),
('US', 'BR', 28.00, 5.50, 2.6, true, NOW(), NOW()),
('US', 'MX', 22.00, 4.20, 2.1, true, NOW(), NOW()),
('US', 'SG', 25.00, 5.50, 2.4, true, NOW(), NOW())
ON CONFLICT (origin_country, destination_country) DO NOTHING;

-- Update shipping routes with delivery options and processing times
