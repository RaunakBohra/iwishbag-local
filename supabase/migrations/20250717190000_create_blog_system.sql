-- Create blog system tables and data
-- This migration creates the complete blog system
...
BEGIN
    IF NOT EXISTS (
        ...
        AND policyname = 'blog_categories_select_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_categories' 
        AND policyname = 'blog_categories_insert_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_categories' 
        AND policyname = 'blog_categories_update_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_categories' 
        AND policyname = 'blog_categories_delete_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_tags' 
        AND policyname = 'blog_tags_select_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_tags' 
        AND policyname = 'blog_tags_insert_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_tags' 
        AND policyname = 'blog_tags_update_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_tags' 
        AND policyname = 'blog_tags_delete_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND policyname = 'blog_posts_select_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_posts' 
        AND policyname = 'blog_posts_insert_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_posts' 
        AND policyname = 'blog_posts_update_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_posts' 
        AND policyname = 'blog_posts_delete_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_post_tags' 
        AND policyname = 'blog_post_tags_select_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_post_tags' 
        AND policyname = 'blog_post_tags_insert_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_post_tags' 
        AND policyname = 'blog_post_tags_update_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'blog_post_tags' 
        AND policyname = 'blog_post_tags_delete_policy'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tgname = 'blog_categories_updated_at_trigger'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'blog_tags_updated_at_trigger'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'blog_posts_updated_at_trigger'
    ) THEN
