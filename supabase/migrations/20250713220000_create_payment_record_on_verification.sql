-- Create a proper payment update function that works with the payment_records system
-- This will create payment records which will automatically update amount_paid via trigger
