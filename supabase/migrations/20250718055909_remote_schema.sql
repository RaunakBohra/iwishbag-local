...
CREATE OR REPLACE FUNCTION "public"."get_popular_posts"("limit_count" integer DEFAULT 5) RETURNS TABLE("id" "uuid", "title" character varying, "slug" character varying, "excerpt" "text", "featured_image_url" "text", "published_at" timestamp with time zone, "reading_time_minutes" integer, "category_name" character varying, "views_count" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_related_posts"("post_slug" "text", "limit_count" integer DEFAULT 3) RETURNS TABLE("id" "uuid", "title" character varying, "slug" character varying, "excerpt" "text", "featured_image_url" "text", "published_at" timestamp with time zone, "reading_time_minutes" integer, "category_name" character varying, "views_count" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE TRIGGER "blog_categories_updated_at_trigger" BEFORE UPDATE ON "public"."blog_categories" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "blog_posts_updated_at_trigger" BEFORE UPDATE ON "public"."blog_posts" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "blog_tags_updated_at_trigger" BEFORE UPDATE ON "public"."blog_tags" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_blog_tags_updated_at" BEFORE UPDATE ON "public"."blog_tags" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_tag_usage_count_trigger" AFTER INSERT OR DELETE ON "public"."blog_post_tags" FOR EACH ROW EXECUTE FUNCTION "public"."update_tag_usage_count"();
