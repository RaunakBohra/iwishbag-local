-- Final Notification System Consolidation
-- Simplified version without conflicts
...
-- Update the existing should_send_notification function if needed
...
-- =====================================================
-- PART 6: SIMPLE DATA MIGRATION
-- =====================================================

-- Migrate unique users from customer_notification_preferences
INSERT INTO notification_preferences_unified (user_id, created_at, updated_at)
SELECT DISTINCT 
    user_id,
    MIN(created_at),
    MAX(updated_at)
...
-- =====================================================
-- Support System: Already well-designed, no changes needed
-- - support_system: Main table for tickets, rules, templates
-- - support_interactions: Replies and status changes
-- - Views provide easy access
--
-- Notification System: Consolidated into 3 tables
-- - notifications: All notification records (enhanced)
-- - notification_preferences_unified: User preferences
-- - notification_templates: Reusable templates
--
-- Tables to drop after verification:
-- - customer_notification_preferences
-- - customer_notification_profiles
-- - customer_package_notifications
-- - package_notifications
-- - payment_alert_thresholds
-- - messages (if not used for chat)
