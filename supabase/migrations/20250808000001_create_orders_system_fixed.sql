-- Create Orders System Tables - Fixed Version
-- Comprehensive order management system with proper relationships to quotes_v2
...
CREATE INDEX idx_orders_tracking_id ON orders(tracking_id) WHERE tracking_id IS NOT NULL;

CREATE INDEX idx_order_items_order_id ON order_items(order_id);
CREATE INDEX idx_order_items_quote_id ON order_items(quote_id) WHERE quote_id IS NOT NULL;
...
COMMENT ON TABLE order_items IS 'Individual items within each order, linked to quotes_v2';
