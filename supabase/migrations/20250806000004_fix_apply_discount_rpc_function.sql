-- Fix the apply_discount_to_quote RPC function to match actual data structure
...
-- Add comment
COMMENT ON FUNCTION apply_discount_to_quote(UUID, TEXT[], UUID) IS 'Applies discount codes to a quote, recalculates totals, and tracks usage for analytics - FIXED VERSION';