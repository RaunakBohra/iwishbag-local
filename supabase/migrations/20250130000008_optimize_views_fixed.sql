-- Optimize Views and Remove Unnecessary Ones (Fixed)
...
WHERE system_type = 'ticket' AND is_active = true AND ticket_data->>'assigned_to' IS NOT NULL;
...
ON received_packages(customer_address_id, package_status, storage_start_date) 
...
ON customer_addresses(user_id, is_active) 
