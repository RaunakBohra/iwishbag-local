-- ============================================================================
-- ADD DELETE FUNCTION FOR HSN MASTER TABLE
-- ============================================================================

-- Function to delete HSN record from master table (admin only)
...
GRANT EXECUTE ON FUNCTION delete_hsn_master_record(VARCHAR) TO authenticated;

-- Add RLS policy for delete on hsn_master
CREATE POLICY "Admins can delete HSN master records" ON hsn_master
  FOR DELETE
  USING (
    auth.uid() IN (
