...
const serviceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdyZ3ZscnZ5d3NmbW5ta3hyZWNkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MDQxMTMxMiwiZXhwIjoyMDY1OTg3MzEyfQ.gRRd3vm7s4iwlGLfXejFOXIz9ulfaywP64OjOWmGqpQ';
...
async function runMigration() {
  ...
  if (countriesError) {
    ...
    countries.forEach(country => {
      console.log(`${country.code} (${country.name}): ${country.default_gateway} - ${country.available_gateways?.join(', ')}`);
    });
  }
