...
const Cart = React.lazy(() => import('@/components/cart/ModernCart').then((m) => ({ default: m.ModernCart })));
const Checkout = React.lazy(() => import('@/components/checkout/ModernCheckout').then((m) => ({ default: m.ModernCheckout })));
