            ...
            <div className="space-y-3 mb-6">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`rounded-full p-2 ${selectedWeight === 'ai' ? 'bg-blue-100' : 'bg-slate-100'}`}
                    >
                      <Brain
                        className={`h-5 w-5 ${selectedWeight === 'ai' ? 'text-blue-600' : 'text-slate-600'}`}
                      />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <ChevronRight
                      className={`h-4 w-4 transition-transform ${selectedWeight === 'ai' ? 'rotate-90' : ''}`}
                    />
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`rounded-full p-2 ${selectedWeight === 'manual' ? 'bg-slate-100' : 'bg-slate-100'}`}
                    >
                      <Scale
                        className={`h-5 w-5 ${selectedWeight === 'manual' ? 'text-slate-600' : 'text-slate-600'}`}
                      />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <ChevronRight
                      className={`h-4 w-4 transition-transform ${selectedWeight === 'manual' ? 'rotate-90' : ''}`}
                    />
                  </div>
                </div>
              </div>
            ...
            {selectedWeight !== 'hsn' && (
              <div className="bg-amber-50 rounded-lg p-4 border border-amber-200 mb-4">
                ...
                <p className="text-sm text-amber-800 mb-3">
                  For international shipping and customs compliance, we recommend using the HSN
                  database weight (1.5 kg) as it's based on official trade classifications.
                </p>
                <button
                  onClick={() => setSelectedWeight('hsn')}
