...
export const QuoteBreakdownHeader: React.FC<QuoteBreakdownHeaderProps> = ({
  ...
  return (
    <CardHeader className="flex flex-col space-y-1.5 p-6 bg-card border border-border rounded-lg">
      <div className="flex flex-col items-center text-center">
        <h3 className="text-xl font-semibold tracking-tight mb-4 text-foreground">Quote Details</h3>
        <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-1 bg-muted border border-border rounded-lg px-3 py-1">
