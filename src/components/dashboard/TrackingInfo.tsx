    ...
    if (!order.shipping_carrier || !order.tracking_number) {
        return (
             <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground">Your order is being prepared for shipment. Tracking information will appear here soon.</p>
                </CardContent>
            </Card>
        );
    }
                ...
                <div className="space-y-1">
                 ...
                 <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => copyToClipboard(order.tracking_number!)}>
