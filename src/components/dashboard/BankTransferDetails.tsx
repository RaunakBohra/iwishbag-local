  ...
  return (
    <Card className="shadow-none border-dashed bg-muted/20">
      ...
      <CardContent className="space-y-4 text-sm">
        <div>
          <p>
            <strong>Bank Name:</strong> {defaultAccount.bank_name}
          </p>
          <p>
            <strong>Account Name:</strong> {defaultAccount.account_name}
          </p>
          <p>
            <strong>Account Number:</strong> {defaultAccount.account_number}
          </p>
          {defaultAccount.swift_code && (
            <p>
              <strong>SWIFT Code:</strong> {defaultAccount.swift_code}
            </p>
          )}
          {defaultAccount.currency_code && (
            <p>
              <strong>Currency:</strong> {defaultAccount.currency_code}
            </p>
          )}
        </div>
