...
export const QuoteBreakdownDetails: React.FC<QuoteBreakdownDetailsProps> = ({
  ...
  const { formatPrice, formatPriceWithUSD, displayCurrency, exchangeRate } =
    useQuoteDisplayCurrency(quote);
            ...
            return (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm font-semibold text-gray-900">{formatPrice(item.amount)}</p>
                </div>
              </div>
            );
          })}
        ...
        {discount > 0 && (
          <>
            ...
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              ...
              <div className="text-right">
                <p className="text-sm font-semibold text-green-700">-{formatPrice(discount)}</p>
              </div>
            </div>
          </>
        )}
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              {quote.destination_country
                ? `Delivered to ${quote.destination_country}`
                : 'Final cost'}
            </p>
          </div>
          <div className="text-right">
