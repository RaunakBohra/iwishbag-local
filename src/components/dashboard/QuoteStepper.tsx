    ...
    <div className={cn('w-full bg-card border border-border rounded-lg p-6', className)}>
      <div className="relative flex items-center justify-between px-4 md:px-0">
        ...
        {displaySteps.map((step, index) => {
          const isActive =
            step.id === currentStep ||
            (rejected && step.id === 'rejected' && currentStep === 'rejected');
              ...
              <motion.button
                ...
                className={cn(
                  ...
                  !isActive &&
                    !isCompleted &&
                    !isRejectedStep &&
                    'border-border bg-muted text-muted-foreground hover:border-foreground/50 hover:bg-muted/80',
                  ...
                  >
                    {React.cloneElement(step.icon as React.ReactElement, {
                      className: cn(
                        ...
                        (isActive || isCompleted) && !isRejectedStep
                          ? 'text-background'
