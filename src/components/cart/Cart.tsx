...
import { Trash2, ShoppingCart, Save, Package, ArrowRight } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          ...
          {getSelectedCartItems().length > 0 && (
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => setShowBulkSaveConfirm(true)}>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {getSelectedSavedItems().length > 0 && (
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => setShowBulkMoveConfirm(true)}>
  ...
  return (
    <div className="container py-12 space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">Manage your cart items and saved items</p>
      </div>
        ...
        <div className="lg:col-span-2">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="cart">Cart ({itemCount})</TabsTrigger>
              <TabsTrigger value="saved">Saved ({savedItemCount})</TabsTrigger>
            </TabsList>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span>Subtotal:</span>
                      <span>
                        <CartTotal items={getSelectedCartItems()} />
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Weight:</span>
