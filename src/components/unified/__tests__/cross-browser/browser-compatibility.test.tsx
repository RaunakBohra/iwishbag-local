...
describe('Cross-Browser Compatibility Tests', () => {
  ...
  describe('Chrome Browser Compatibility', () => {
    ...
    it('should render UnifiedQuoteCard correctly in Chrome', async () => {
      renderWithProviders(
        <UnifiedQuoteCard quote={crossBrowserTestQuote} viewMode="customer" layout="detail" />,
      );
    ...
    it('should support Chrome-specific performance features', async () => {
      const PerformanceTest = () => {
        ...
        return (
          <UnifiedQuoteList quotes={[crossBrowserTestQuote]} viewMode="customer" layout="list" />
        );
      };
    ...
    it('should work with Firefox flexbox implementation', async () => {
      const FlexboxTest = () => (
        <div className="flex flex-col gap-4" data-testid="firefox-flex">
          <UnifiedQuoteBreakdown quote={crossBrowserTestQuote} viewMode="customer" />
        </div>
      );
  ...
  describe('Safari Browser Compatibility', () => {
    ...
    it('should handle Safari Service Worker limitations', async () => {
      const ServiceWorkerTest = () => {
        ...
        return <div data-testid="sw-support">{swSupported ? 'supported' : 'not-supported'}</div>;
      };
  ...
  describe('Edge Browser Compatibility', () => {
    ...
    it('should work with Edge CSS container queries', async () => {
      const ContainerQueriesTest = () => (
        <div className="container-type-inline-size" data-testid="edge-container">
          <UnifiedQuoteList quotes={[crossBrowserTestQuote]} viewMode="customer" layout="list" />
        </div>
      );
  ...
  describe('Mobile Browser Compatibility', () => {
    it('should work correctly on mobile Chrome', async () => {
      ...
      renderWithProviders(
        <UnifiedQuoteCard quote={crossBrowserTestQuote} viewMode="customer" layout="compact" />,
      );
    ...
    it('should handle touch events on mobile', async () => {
      ...
      const TouchEventTest = () => {
        ...
        return (
          <div onTouchStart={handleTouch} data-testid="touch-element">
            <UnifiedQuoteActions
              quote={crossBrowserTestQuote}
              viewMode="customer"
              onAction={vi.fn()}
            />
            <div data-testid="touch-status">{touched ? 'touched' : 'not-touched'}</div>
          </div>
        );
      };
      ...
      const FallbackTest = () => {
        ...
        return (
          <div data-testid="fallback-container">
            {useModernFeatures ? (
              <div className="container-type-inline-size">Modern layout with container queries</div>
            ) : (
              <div className="responsive-grid">Fallback layout with media queries</div>
            )}
            <UnifiedQuoteBreakdown quote={crossBrowserTestQuote} viewMode="customer" />
          </div>
        );
