...
import { DeliveryEstimate, formatDeliveryEstimate, createDeliveryTimeline } from '@/lib/delivery-estimates';
        ...
        <CardContent className="space-y-4">
          ...
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-green-700 mt-1">
              Based on {isPaymentPhase ? 'payment date' : 'quote request date'}: {format(startDate, 'MMM do, yyyy')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-3 bg-yellow-50 rounded border border-yellow-200">
              ...
              <p className="text-yellow-800">
                {estimate.processing_days} business day{estimate.processing_days > 1 ? 's' : ''}
              </p>
            ...
            <div className="p-3 bg-purple-50 rounded border border-purple-200">
              ...
              <p className="text-purple-800">
                {estimate.customs_processing_days} business day{estimate.customs_processing_days > 1 ? 's' : ''}
              </p>
        ...
        <CardContent className="space-y-3">
          <div className="text-sm space-y-2">
            <p className="flex items-start gap-2">
              ...
              <span>Delivery times are estimates and may vary due to customs processing and local conditions.</span>
            </p>
            <p className="flex items-start gap-2">
              <span className="text-blue-600 font-medium">•</span>
            ...
            {!isPaymentPhase && (
              <p className="flex items-start gap-2">
                ...
                <span>Complete payment to get the most accurate delivery timeline based on your payment date.</span>
              </p>
            )}
          </div>
        </CardContent>
