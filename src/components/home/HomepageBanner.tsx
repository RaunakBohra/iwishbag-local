      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg viewBox="0 0 1200 800" className="w-full h-full">
            <path
              d="M100 200 Q200 150 300 200 T500 250 Q600 280 700 250 T900 200 Q1000 180 1100 200"
              stroke="currentColor"
              strokeWidth="2"
              fill="none"
              className="text-teal-600"
            />
            <circle cx="200" cy="180" r="3" fill="currentColor" className="text-teal-600" />
            <circle cx="400" cy="220" r="3" fill="currentColor" className="text-teal-600" />
            <circle cx="600" cy="260" r="3" fill="currentColor" className="text-teal-600" />
            <circle cx="800" cy="230" r="3" fill="currentColor" className="text-teal-600" />
            <circle cx="1000" cy="190" r="3" fill="currentColor" className="text-teal-600" />
          </svg>
        </div>
