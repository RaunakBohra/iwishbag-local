...
const testimonials = [
  {
    ...
    review: "Amazing service! Got my iPhone delivered in just 10 days. The price was 30% cheaper than local stores, even after customs. The tracking was accurate throughout.",
    flag: "🇮🇳",
    savedAmount: "₹25,000"
  },
  {
    ...
    review: "Found a great gaming laptop on JD.com that wasn't available in Nepal. The team handled everything perfectly. Customs clearance was smooth!",
    flag: "🇳🇵",
  ...
  },
  {
    ...
    review: "I've been trying to get authentic Japanese skincare products for months. This service made it so easy! Products arrived well-packaged and genuine.",
    flag: "🇬🇧",
    savedAmount: "£150"
  }
];
            ...
            <div className="relative z-10">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 mb-6">
                <p className="text-sm font-medium text-gray-700">
                  Purchased: <span className="text-blue-600">{testimonials[currentIndex].product}</span>
                </p>
