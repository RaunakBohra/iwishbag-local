    ...
    <section ref={sectionRef} className="py-16 bg-gray-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 mt-16">
        <div className="animate-fadeInUp">
          <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Recently Purchased</h3>
          
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 max-w-6xl mx-auto">
            {[
              { product: "iPhone 15 Pro", price: "$999", image: "📱", from: "USA" },
              { product: "Sony Camera", price: "$1,200", image: "📷", from: "Japan" },
              { product: "Gaming Console", price: "$499", image: "🎮", from: "USA" },
              { product: "Designer Bag", price: "$850", image: "👜", from: "Italy" },
              { product: "Smart Watch", price: "$399", image: "⌚", from: "Korea" },
              { product: "Sneakers", price: "$180", image: "👟", from: "Germany" }
            ].map((item, index) => (
              <div
                key={index}
