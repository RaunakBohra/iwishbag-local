...
import { Shield, Lock, CreditCard, Award, Headphones, RefreshCw, TrendingUp, Users } from "lucide-react";
...
const shippingPartners = [
  ...
  { name: "USPS", logo: "https://upload.wikimedia.org/wikipedia/commons/4/4a/USPS_Logo.svg" }
];
    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className="text-sm font-semibold text-blue-600 uppercase tracking-wider">Why Trust Us</span>
          <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6">
            Shop with <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Complete Confidence</span>
          </h2>
        ...
        >
          <div className="grid md:grid-cols-2 gap-12">
            {/* Payment Methods */}
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Accepted Payment Methods</h3>
            ...
            {/* Shipping Partners */}
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Trusted Shipping Partners</h3>
              <div className="flex flex-wrap justify-center gap-6">
