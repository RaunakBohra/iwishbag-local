    ...
    <section className="py-16 lg:py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="absolute top-32 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-blue-200 to-transparent transform hidden lg:block" />

          {/* Mobile Connection Line */}
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-transparent via-blue-200 to-transparent transform lg:hidden" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 relative">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Card */}
                <div className="group relative bg-white rounded-2xl p-6 lg:p-8 border border-gray-100 hover:border-blue-200 transition-all duration-300 hover:shadow-lg hover:shadow-blue-50 h-full ml-8 lg:ml-0 lg:flex lg:flex-col">
                  {/* Mobile: Step Number on the left */}
                  <div className="absolute -left-10 top-6 lg:top-auto lg:-top-4 lg:left-8 w-8 h-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-lg z-10">
                    {step.id}
                  </div>
                  ...
                  <div className="hidden lg:flex lg:flex-col lg:h-full">
                    {/* Icon Container */}
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                ...
                {index < steps.length - 1 && (
                  <div className="lg:hidden absolute -left-6 -bottom-3 w-4 h-4 rounded-full bg-blue-200 border-2 border-white shadow-sm z-10" />
                )}
              </motion.div>
            ))}
          </div>
        ...
        >
          {[
            ...
            <div key={index} className="text-center p-3 lg:p-4 rounded-xl bg-white border border-gray-100 hover:border-blue-200 transition-colors duration-200">
