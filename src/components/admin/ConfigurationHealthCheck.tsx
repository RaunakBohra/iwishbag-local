        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 mt-1">{overallStatus.description}</div>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <Button variant="ghost" size="sm" onClick={refreshStatus} className="h-7 px-2">
        ...
        {!compact && (
          <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
            <CollapsibleContent>
              ...
              {/* Category Details */}
              {Object.entries(configStatus.categories).map(
                ([category, info]) =>
                          ...
                          .map((check) => (
                            ...
                            >
                              <div className="flex items-center space-x-2">
                                ...
                                <span
                                  className={cn(check.hasValue ? 'text-gray-900' : 'text-gray-600')}
                                >
                                  {check.name}
                                </span>
                              </div>
              ...
              {(configStatus.missingRequired.length > 0 ||
                configStatus.missingOptional.length > 0) && (
                <div className="bg-gray-50 rounded-lg p-3 mt-4">
                  <div className="text-sm font-medium text-gray-900 mb-2">Configuration Help</div>
                  <div className="text-xs text-gray-600 mb-2">
                    Add missing environment variables to your .env file to enable full
                    functionality.
                  </div>
                  <Button
                    variant="outline"
