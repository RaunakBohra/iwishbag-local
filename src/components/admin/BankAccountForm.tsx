...
export const BankAccountForm = ({ editingAccount, onSubmit, onCancel, isProcessing }: BankAccountFormProps) => {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input id="account_name" name="account_name" defaultValue={editingAccount?.account_name || ''} required />
          </div>
          <div>
            <Label htmlFor="account_number">Account Number</Label>
            <Input id="account_number" name="account_number" defaultValue={editingAccount?.account_number || ''} required />
          </div>
          <div>
            <Label htmlFor="bank_name">Bank Name</Label>
            <Input id="bank_name" name="bank_name" defaultValue={editingAccount?.bank_name || ''} required />
          </div>
          <div>
            <Label htmlFor="branch_name">Branch Name</Label>
            <Input id="branch_name" name="branch_name" defaultValue={editingAccount?.branch_name || ''} />
          </div>
          <div>
            <Label htmlFor="swift_code">SWIFT/BIC Code</Label>
            <Input id="swift_code" name="swift_code" defaultValue={editingAccount?.swift_code || ''} />
          </div>
          <div>
