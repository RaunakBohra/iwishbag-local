...
interface CustomsRulesTabProps {
  rules: any[];
...
export const CustomsRulesTab: React.FC<CustomsRulesTabProps> = ({
  rules,
  onAdd,
  onUpdate,
  onDelete,
  ...
  const [formData, setFormData] = useState<CustomsRuleForm>({
    name: '',
    priority: 0,
    isActive: true,
    conditions: {},
  ...
  const handleEditRule = () => {
    ...
    onUpdate('customs', editingRule.id, updatedRule);
    setEditingRule(null);
    resetForm();
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-semibold">Customs Rules</h2>
          <p className="text-muted-foreground">
            Configure customs and duty calculation rules for different product categories
          </p>
        </div>
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Add Customs Rule</DialogTitle>
              <DialogDescription>
                Create a new rule for customs duty calculations
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Electronics High Value"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">What happens when this rule is applied</p>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="category">Customs Category</Label>
                    <Select
                  ...
                  <div>
                    <Label htmlFor="duty-percentage">Duty Percentage (%)</Label>
                    <Input
                      id="duty-percentage"
                      type="number"
                      min="0"
                      max="100"
                      step="0.1"
                      value={formData.actions.dutyPercentage}
                      onChange={(e) => setFormData(prev => ({
                        ...prev,
                        actions: { ...prev.actions, dutyPercentage: parseFloat(e.target.value) || 0 }
                      }))}
                    />
                  </div>
                </div>
        ...
        <CardContent>
          {rules.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">No customs rules configured</p>
              <p className="text-sm text-muted-foreground">
                Add rules to enable automatic customs calculations
              </p>
            </div>
          ) : (
            <div className="space-y-4">
      ...
      {editingRule && (
        <Dialog open={!!editingRule} onOpenChange={() => setEditingRule(null)}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Edit Customs Rule</DialogTitle>
              <DialogDescription>
                Update the customs rule configuration
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="edit-category">Customs Category</Label>
                    <Select
                      value={formData.actions.category}
                      onValueChange={(value) => setFormData(prev => ({
                        ...prev,
                  ...
                  <div>
                    <Label htmlFor="edit-duty-percentage">Duty Percentage (%)</Label>
                    <Input
                      id="edit-duty-percentage"
                      type="number"
                      min="0"
                      max="100"
                      step="0.1"
