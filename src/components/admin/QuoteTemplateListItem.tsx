...
export const QuoteTemplateListItem = ({ template, onEdit, onDelete }: QuoteTemplateListItemProps) => {
    return (
        <Card>
            <CardHeader>
                <CardTitle className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <Button size="sm" variant="outline" onClick={() => onEdit(template)}>Edit</Button>
