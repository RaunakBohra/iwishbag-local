...
export const QuoteFilters = ({
  ...
  onAmountRangeChange,
  countryFilter = 'all',
  onCountryFilterChange: _onCountryFilterChange,
  priorityFilter = 'all',
      ...
      <CardContent className="space-y-4 py-6 bg-white rounded-b-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-6 items-stretch">
          ...
          <div className="flex flex-1 gap-6 min-w-0 items-center">
            ...
            <Select
              value={purchaseCountryFilter || 'all'}
              onValueChange={onPurchaseCountryFilterChange}
          ...
          <div className="pt-4 border-t space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select
                  value={shippingCountryFilter || 'all'}
                  onValueChange={onShippingCountryFilterChange}
                  disabled={countriesLoading}
                >
                  <SelectTrigger>
