    ...
    <div className={cn('flex items-center gap-3', className)}>
      ...
      <div className="relative flex items-center">
        <Input
          ...
          min="0"
        />
        <span className="absolute right-10 text-xs text-gray-500 pointer-events-none font-medium">
          kg
        </span>
          ...
          <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent className="w-72 p-0 shadow-lg border border-gray-200" align="start">
              <div className="p-3 border-b border-gray-100">
                <div className="text-sm font-semibold text-gray-900">Weight Suggestions</div>
