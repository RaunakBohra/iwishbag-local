...
export const CompactShippingOptions: React.FC<CompactShippingOptionsProps> = ({
  ...
  const recommendedOption = topRecommendation ? 
    shippingOptions.find(opt => opt.id === topRecommendation.option_id) : null;
      ...
      {recommendedOption && selectedOptionId !== recommendedOption.id && (
        <div className="mt-2 flex items-center justify-between bg-green-50 p-2 rounded text-xs">
          <div className="flex items-center text-green-700">
            ...
            <span>Save ${topRecommendation.savings_usd.toFixed(2)} with {recommendedOption.carrier}</span>
          </div>
          <Button
            size="sm"
            variant="outline"
              ...
              return (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 text-xs">
                    {rec.reason === 'cost_savings' && <TrendingDown className="w-3 h-3 text-green-600" />}
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge variant="outline" className="text-xs h-4 px-1">{option.name}</Badge>
