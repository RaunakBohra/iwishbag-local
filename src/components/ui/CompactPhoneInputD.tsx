...
interface CompactPhoneInputDProps {
  countries: Country[];
  value?: string;
...
export function CompactPhoneInputD({
  countries,
  value = '',
  onChange,
  onValidationChange,
  ...
  return (
    <div className={`relative ${className}`}>
      <div 
        ...
        `}
      >
        {/* Inline Country Selector - Inside Input */}
        <button
          type="button"
          onClick={() => !disabled && setShowCountryDropdown(!showCountryDropdown)}
          disabled={disabled}
          className={`
            flex items-center gap-1.5 pl-3 pr-2 py-2 hover:bg-gray-50 transition-colors rounded-l-lg
