...
export const Display = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn(designSystem.typography.display, 'text-gray-900', className)}
      {...props}
    >
      {children}
    </h1>
...
export const BodyLarge = React.forwardRef<HTMLParagraphElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(designSystem.typography.bodyLarge, 'text-gray-700', className)}
      {...props}
    >
      {children}
    </p>
...
export const Body = React.forwardRef<HTMLParagraphElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(designSystem.typography.body, 'text-gray-700', className)}
      {...props}
    >
      {children}
    </p>
...
export const BodySmall = React.forwardRef<HTMLParagraphElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(designSystem.typography.bodySmall, 'text-gray-600', className)}
      {...props}
    >
      {children}
    </p>
...
export const Caption = React.forwardRef<HTMLParagraphElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(designSystem.typography.caption, 'text-gray-500', className)}
      {...props}
    >
      {children}
    </p>
...
export const SectionHeading = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <h2
      ref={ref}
      className={cn(designSystem.typography.sectionTitle, 'text-gray-900 mb-4', className)}
      {...props}
    >
      {children}
    </h2>
...
export const SubHeading = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn(designSystem.typography.h3, 'text-gray-900 mb-3', className)}
      {...props}
    >
      {children}
    </h3>
...
export const SectionDescription = React.forwardRef<HTMLParagraphElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(designSystem.typography.bodyLarge, 'text-gray-600 max-w-2xl', className)}
      {...props}
    >
      {children}
    </p>
...
export const StatNumber = React.forwardRef<HTMLDivElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('text-2xl sm:text-3xl lg:text-4xl font-semibold text-gray-900', className)}
      {...props}
    >
      {children}
    </div>
...
export const StatLabel = React.forwardRef<HTMLParagraphElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn(designSystem.typography.bodySmall, 'text-gray-500', className)}
      {...props}
    >
      {children}
    </p>
...
export const PageTitle = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn(designSystem.typography.pageTitle, 'text-gray-900', className)}
      {...props}
    >
      {children}
    </h1>
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ children, className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn(designSystem.typography.cardTitle, 'text-gray-900', className)}
      {...props}
    >
      {children}
    </h3>
...
>(({ children, className, ...props }, ref) => (
  <a
    ref={ref}
    className={cn(designSystem.typography.navLink, 'text-gray-700 hover:text-gray-900', className)}
    {...props}
  >
    {children}
  </a>
...
>(({ children, className, ...props }, ref) => (
  <label
    ref={ref}
    className={cn(designSystem.typography.label, 'text-gray-700', className)}
    {...props}
  >
    {children}
  </label>
