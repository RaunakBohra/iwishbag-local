    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <div className="relative">
        ...
        <select
          ...
          className="appearance-none bg-white border border-gray-300 rounded-lg px-3 py-2 pr-8 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 cursor-pointer hover:border-gray-400 transition-colors"
