...
const PAYMENT_ERROR_CODES: Record<string, Omit<PaymentError, 'code'>> = {
  ...
  NETWORK_ERROR: {
    ...
    userMessage:
      "We're having trouble connecting to our payment provider. Please check your internet connection and try again.",
    recoveryOptions: [
  ...
  TIMEOUT_ERROR: {
    ...
    userMessage:
      'Your payment is taking longer than expected. Please wait a moment and check your payment status.',
    recoveryOptions: [
  ...
  CURRENCY_NOT_SUPPORTED: {
    ...
    userMessage:
      "This payment method doesn't support your currency. Please try a different payment method.",
    recoveryOptions: [
      'Try a different payment method',
