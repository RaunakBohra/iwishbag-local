  ...
  public: {
    Tables: {
      ...
      fallback_usage_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: 'fallback_usage_logs_quote_id_fkey';
            columns: ['quote_id'];
            isOneToOne: false;
          ...
          {
            foreignKeyName: 'fallback_usage_logs_user_id_fkey';
            columns: ['user_id'];
            isOneToOne: false;
      ...
      global_calculation_defaults: {
        ...
        Relationships: [
          {
            foreignKeyName: 'global_calculation_defaults_created_by_fkey';
            columns: ['created_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'global_calculation_defaults_updated_by_fkey';
            columns: ['updated_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
      ...
      profiles: {
        Row: {
          ...
          ticket_notifications: Json | null;
      ...
      quotes: {
        Row: {
          admin_notes: string | null;
          auto_classification_data: Json | null;
          ...
          item_level_calculations: Json | null;
          items: Json;
      ...
      reply_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: 'reply_templates_created_by_fkey';
            columns: ['created_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
    ...
    Functions: {
      ...
      get_available_credit_notes: {
        Args: { p_min_amount?: number; p_customer_id?: string };
        Returns: {
          credit_note_id: string;
          note_number: string;
          amount: number;
      ...
      user_wants_notification: {
        Args: { user_id: string; notification_type: string };
        Returns: boolean;
      };
      validate_message_attachment_path: {
