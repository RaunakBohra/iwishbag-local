      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-gray max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Purchase products on your behalf, handle international shipping, 
                  and manage customs documentation.
                </p>
              </div>
              ...
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 leading-relaxed">
                  We don't manufacture products, control merchant policies, 
                  or determine customs duties.
                </p>
              </div>
            </div>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">User Responsibilities</h2>
            <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Our pricing includes item cost, shipping, handling, and any applicable fees. 
              Prices are quoted in USD and may vary based on exchange rates.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">
                  Subject to our returns policy
                </p>
              </div>
            </div>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">Shipping and Delivery</h2>
            <p className="text-gray-600 mb-8 leading-relaxed">
              We strive to deliver your orders safely and on time, but shipping times may vary 
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              ...
              determined by your country's customs authorities.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-12">
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Customer Responsibility:</strong> You are responsible for all customs duties, 
                    taxes, and fees imposed by your country.
                  </p>
                </li>
                <li className="flex items-start">
                  <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Estimates Only:</strong> Our duty calculations are estimates and may differ 
                    from actual amounts charged by customs.
                  </p>
                </li>
                <li className="flex items-start">
                  <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Compliance:</strong> We comply with all applicable import/export regulations 
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">Limitation of Liability</h2>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-12">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Examples of Prohibited Items</h3>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              ...
              <div className="mt-4 space-y-2">
                <p className="text-gray-700"><strong>Email:</strong> legal@iwishbag.com</p>
                <p className="text-gray-700"><strong>Address:</strong> iwishBag Legal Department, [Your Address]</p>
              </div>
            </div>
          </div>
        </div>
