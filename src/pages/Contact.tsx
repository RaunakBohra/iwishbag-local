  ...
  const faqs = [
    {
      ...
      answer:
        'Typically 7-21 business days depending on the destination country and customs processing. Express shipping options are available for faster delivery.',
    },
    {
      question: 'How are customs duties calculated?',
      answer:
        'Customs duties are calculated based on the product category, declared value, and destination country regulations. Our calculator provides accurate estimates upfront.',
    },
    {
      question: 'Can I track my shipment?',
      answer:
        "Yes! You'll receive tracking information as soon as your order ships. Track your package in real-time through our dashboard or the carrier's website.",
    },
    {
      question: 'What payment methods do you accept?',
      answer:
        'We accept all major credit cards, PayPal, Google Pay, Apple Pay, and bank transfers. All payments are secured with SSL encryption.',
    },
    {
      question: 'What if my package is damaged or lost?',
      answer:
        "All shipments are insured. If your package is damaged or lost, we'll work with the carrier to file a claim and ensure you receive a replacement or refund.",
    },
    {
      question: 'Do you handle returns?',
      answer:
        "Yes, we facilitate returns according to the seller's return policy. We'll handle the international return shipping and ensure you receive your refund.",
    },
  ];
              ...
              <AnimatedSection key={index} animation="fadeInUp" delay={index * 100}>
                <Card className="h-full hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div
                      className={`w-12 h-12 rounded-full bg-gradient-to-r ${method.color} flex items-center justify-center mb-4`}
                    >
