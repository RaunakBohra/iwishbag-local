      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-gray max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">Information We Collect</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">How We Use Your Information</h2>
            <p className="text-gray-600 mb-8 leading-relaxed">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Service Providers:</strong> Trusted partners who help us deliver our services, 
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">International Transfers</h2>
            <p className="text-gray-600 mb-12 leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">Cookies and Tracking</h2>
            <p className="text-gray-600 mb-12 leading-relaxed">
              We use cookies and similar technologies to improve your experience, analyze usage, 
              and deliver personalized content.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-12">Changes to This Policy</h2>
            <p className="text-gray-600 mb-12 leading-relaxed">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              ...
              <div className="space-y-2">
                <p className="text-gray-700"><strong>Email:</strong> privacy@iwishbag.com</p>
                <p className="text-gray-700"><strong>Address:</strong> iwishBag Privacy Team, [Your Address]</p>
              </div>
            </div>
          </div>
        </div>
