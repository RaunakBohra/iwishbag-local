...
const CountriesSection = lazy(() => import("@/components/home/CountriesSection").then(m => ({ default: m.CountriesSection })));
const ValuePropsSection = lazy(() => import("@/components/home/ValuePropsSection").then(m => ({ default: m.ValuePropsSection })));
const TestimonialsSection = lazy(() => import("@/components/home/TestimonialsSection").then(m => ({ default: m.TestimonialsSection })));
const CostEstimatorPreview = lazy(() => import("@/components/home/CostEstimatorPreview").then(m => ({ default: m.CostEstimatorPreview })));
const TrustIndicators = lazy(() => import("@/components/home/TrustIndicators").then(m => ({ default: m.TrustIndicators })));
...
export default function Index() {
  ...
  const settings = {
    ...
    heroSubtitle: "Get quotes from Amazon, Flipkart, eBay, Alibaba and more. We handle shipping, customs, and delivery to India and Nepal.",
    primaryColor: "#3B82F6",
