  ...
  const timeline = [
    {
      year: '2019',
      title: 'Founded',
      description: 'Started with a vision to make global shopping accessible',
    },
    {
      year: '2020',
      title: 'First 1000 Customers',
      description: 'Reached our first milestone during challenging times',
    },
    {
      year: '2021',
      title: 'Expanded Services',
      description: 'Added express shipping and customs clearance',
    },
    {
      year: '2022',
      title: 'Global Network',
      description: 'Established partnerships in 50+ countries',
    },
    {
      year: '2023',
      title: 'Tech Innovation',
      description: 'Launched AI-powered cost estimation',
    },
    {
      year: '2024',
      title: 'Market Leader',
      description: 'Became the trusted choice for international shopping',
    },
  ];
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pb-12">
                  <p className="text-lg text-muted-foreground text-center leading-relaxed">
                    We simplify international shipping by providing transparent pricing, reliable
                    service, and expert customs handling. Our goal is to make global commerce
                    accessible to everyone, from individual shoppers to growing businesses. We
                    believe that geographical boundaries shouldn't limit your shopping choices.
                  </p>
                </CardContent>
              </Card>
            </AnimatedSection>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container">
          <AnimatedSection animation="fadeInUp" className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Shop the World?</h2>
