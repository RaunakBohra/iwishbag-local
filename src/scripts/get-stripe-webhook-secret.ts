...
async function getWebhookSecret() {
  ...
  console.log('- Has test keys:', !!stripeGateway.config.test_secret_key && !!stripeGateway.config.test_publishable_key)
  ...
  if (stripeGateway.config.webhook_secret) {
    ...
    if (stripeGateway.config.webhook_secret.startsWith('whsec_879fb65ea8800b283ebf57b86f81d8075897fcaa')) {
