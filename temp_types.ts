  ...
  public: {
    Tables: {
      ...
      support_system: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_support_system_quote_id"
            columns: ["quote_id"]
            isOneToOne: false
            referencedRelation: "quotes"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_recent_survey_feedback: {
        Args: { p_min_rating?: number; p_limit?: number }
        Returns: {
          feedback: string
