...
COMMENT ON TABLE "public"."payment_ledger" IS 'Comprehensive payment tracking with running balances and gateway details';
...
CREATE OR REPLACE TRIGGER "sync_payment_record_to_ledger_trigger" AFTER INSERT ON "public"."payment_records" FOR EACH ROW EXECUTE FUNCTION "public"."sync_payment_record_to_ledger"();
...
ALTER TABLE ONLY "public"."payment_records"
    ADD CONSTRAINT "payment_records_payment_ledger_id_fkey" FOREIGN KEY ("payment_ledger_id") REFERENCES "public"."payment_ledger"("id");
