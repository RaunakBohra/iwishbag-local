...
async function testAirwallexPayment() {
  ...
  const testPaymentData = {
    quoteIds: ['7e3c424e-5cf2-4b73-bc25-82db1afe2675'],
    gateway: 'airwallex',
...
console.log('Testing Airwallex Payment Integration (Authenticated)');
console.log('=' .repeat(60));
...
console.log('\nWatch the function logs in that terminal for detailed debug info!');
console.log('=' .repeat(60));
