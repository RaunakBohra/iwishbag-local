...
async function fixPayUDirect() {
  console.log('🔧 Fixing PayU configuration directly...');
  ...
  try {
    // Update using the specific record ID
    const { data, error } = await supabase
      ...
      .eq('id', '29f3a492-7dd9-43a2-a2ae-7e79a7384435') // PayU record ID
      .select();
